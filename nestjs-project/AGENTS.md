...
## Codex
Seguir AGENTS.md da raiz e as rules de backend. Workflow manual equivalente aos estágios originais, com Spec Kit instalado. Toda verificação roda via Compose isolado.


## Fase 03 — ambiente dedicado

Compose usa o projeto `mba-esai-296`; API no host em 53000 (internamente 3000), MinIO em 59000/59001 e Mailpit em 58025. Worker separado processa BullMQ/Redis com FFmpeg. O procedimento atualizado está em `../docs/phases/phase-03-videos/README.md`. Não execute testes de migrations contra dados de produção.
